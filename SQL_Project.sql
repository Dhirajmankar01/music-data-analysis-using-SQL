...
select count(billing_country) as d, billing_country from invoice
group by billing_country
order by d desc;

--hat are top 3 values of total invoice? 
...
select * from invoice;
select cu.customer_id, cu.first_name, cu.last_name, sum(invoice.total) as totalspending 
from customer as cu 
